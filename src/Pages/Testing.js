      ...
      <div className="col-md">
        <ul className="services-nav flex-column flex-nowrap">
          <li className="nav-item">
            <a className="nav-link" href="#submenu1" data-toggle="collapse" data-target="#submenu1">Who should be tested</a>
            <div className="collapse show" id="submenu1">
              <ul className="flex-column nav">
                <li className="nav-item"><a className="nav-link" href="#">Anyone with Established NCEP ATP III risk factors</a></li>
                <li className="nav-item"><a className="nav-link active" href="#">All chronic conditions</a></li>
                <li className="nav-item"><a className="nav-link" href="#">Metabolic Syndrome</a></li>
               
              </ul>
            </div>
          </li>
          <li className="nav-item"><a className="nav-link" href="#">NCEP Guidelines</a></li>
        ...
        <div className="row d-flex flex-column flex-sm-row flex-md-column mt-3">
          <div className="col-auto col-sm col-md-auto">
            <div className="contact-box contact-box-1">
              ...
              <ul className="icn-list">
                <li><i className="icon-clock" />Mon-Thu 08:00 - 20:00
          ...
          <div className="col-auto col-sm col-md-auto">
            <div className="contact-box contact-box-2">
              ...
              <ul className="icn-list">
                <li><i className="icon-telephone" />
                  <div className="d-flex flex-wrap">
                    <span>Phone:&nbsp;&nbsp;</span>
                    <span>1-800-267-0000<br />
                      1-800-267-0001</span></div>
                </li>
                <li><i className="icon-black-envelope" /><a href="mailto:info@dentco.net">info@meditserv.com</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="question-box mt-3">
          ...
          <form id="questionForm" method="post" noValidate>
            ...
            <textarea className="form-control" name="message" placeholder="Question*" defaultValue={""} />
            <button type="submit" className="btn btn-sm btn-hover-fill mt-15"><i className="icon-right-arrow" /><span>Ask Now</span><i className="icon-right-arrow" /></button>
          </form>
        </div>
      </div>
